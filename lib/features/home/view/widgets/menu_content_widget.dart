      ...
      child: SingleChildScrollView(
        child: BlocBuilder<HomeBloc, HomeState>(
          builder: (context, state) {
            ...
            final List<String> availableAspects = aspectMap.keys.toList()
              ..sort();
                        ...
                        child: Opacity(
                          ...
                          child: MultiSelectCategoryDropdown(
                            ...
                            onItemToggled: (subaspect) {
                              context.read<HomeBloc>().add(
                                  ToggleSubaspectSelectionEvent(subaspect));
                            },
                          ),
                        ),
                      ),
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: AuthButton(
                            onPressed: () {
                              // Trigger filtering with current selections
                              final bloc = context.read<HomeBloc>();
                              final currentState = bloc.state as MenuState;
                              bloc.add(FilterMarkersByAspectAndSubaspect(
                                aspects: currentState.selectedAspects,
                                subaspects: currentState.selectedSubaspects,
                              ));
                            ...
                            buttonStyle: ElevatedButton.styleFrom(
                              ...
                              elevation: 2,
                              overlayColor: AppColors.blue.withOpacity(0.8),
